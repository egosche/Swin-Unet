...
def inference(args, model, test_save_path=None):
    ...
    mean_spec = np.mean(metric_list, axis=0)[3]
    logging.info(f'Testing performance in best val model: mean_dice : {performance} mean_hd95 : {mean_hd95} mean_recall : {mean_recall} mean_spec : {mean_spec}')
